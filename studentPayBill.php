...
<body>
        ...
        <h1 class="text-center" id="welcomeText">HELLO, WELCOME TO <br>HOSTEL ALLOCATION SYSTEM</h1>
        	...
        	<div class="container loginform">
              <input type="text" placeholder="Username" class=" form-control " id="tfs"><br>
              <input type="password" placeholder="Password" class="form-control " id="tfs"><br>
             	<a href="studentdashboard.php" id="btLogin">Login</a><br>
